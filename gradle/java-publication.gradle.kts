...
//                    artifactId = tasks.named<Jar>("jar").archiveBaseName.get()
                ...
                pom {
                    ...
                    url = "https://github.com/classbuddy4j/classbuddy4j"
                    licenses {
                        license {
                            name = "Apache License version 2.0"
                            url = "https://github.com/classbuddy4j/classbuddy4j/blob/main/LICENSE"
                            distribution = "repo"
                        }
                    }
                    developers {
                    ...
                    scm {
                        url = "https://github.com/classbuddy4j/classbuddy4j.git"
                    }
                    issueManagement {
                        url = "https://github.com/classbuddy4j/classbuddy4j/issues"
                        system = "GitHub issues"
                    }
                    ciManagement {
                        url = "https://github.com/classbuddy4j/classbuddy4j/actions"
                        system = "GH Actions"
                    }
                }
            }
